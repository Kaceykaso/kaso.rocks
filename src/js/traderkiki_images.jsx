import traderkiki from "../assets/trader_kiki_logo.png";
...
import lava_lamp_glow from "../assets/lava_lamp_glow.jpg";

export const fullImages = {
    geomatric_triangle_jazz,
    geometric_square_jazz,
    vaporwave_retro_floppy,
    vaporwave_glow_arcade_moon,
    vaporwave_sunset_hoops,
    nineties_memphis_floppy,
    arcade_carpet_glow,
    geometric_rectangle_deco,
